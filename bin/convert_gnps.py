...
sdrf_df["comment[technical replicate]"] = range(1, len(sdrf_df) + 1)
sdrf_df["comment[label]"] = "AC=MS:1002038;NT=label free sample"
sdrf_df["comment[ionization]"] = "ESI Positive"
sdrf_df["comment[injection volume]"] = df["Injection Volume"]
sdrf_df["comment[cleavage agent details]"] = "not applicable"
